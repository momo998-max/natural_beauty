...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\VerifyUserController' => 'getVerifyUserControllerService',
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\CatalogueRepository' => ['privates', 'App\\Repository\\CatalogueRepository', 'getCatalogueRepositoryService', true],
            ...
            'App\\Repository\\EtatCommandeRepository' => ['privates', 'App\\Repository\\EtatCommandeRepository', 'getEtatCommandeRepositoryService', true],
    ...
    /**
     * Gets the private '.service_locator.Kut4Exn' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_Kut4ExnService()
    {
        return $this->privates['.service_locator.Kut4Exn'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'security.firewall.map.context.getproduit' => ['privates', 'security.firewall.map.context.getproduit', 'getSecurity_Firewall_Map_Context_GetproduitService', true],
            ...
            'security.firewall.map.context.verifyCode' => ['privates', 'security.firewall.map.context.verifyCode', 'getSecurity_Firewall_Map_Context_VerifyCodeService', true],
        ], [
            'security.firewall.map.context.api' => '?',
            'security.firewall.map.context.dev' => '?',
            'security.firewall.map.context.getproduit' => '?',
            'security.firewall.map.context.login' => '?',
            'security.firewall.map.context.main' => '?',
            'security.firewall.map.context.registration' => '?',
            'security.firewall.map.context.verifyCode' => '?',
        ]);
    }
    ...
    {
        $a = new \Symfony\Component\Mercure\Jwt\LcobucciFactory($this->getEnv('MERCURE_JWT_SECRET'), 'hmac.sha256');

        $b = new \Symfony\Component\Mercure\Debug\TraceableHub(new \Symfony\Component\Mercure\Hub($this->getEnv('MERCURE_URL'), new \Symfony\Component\Mercure\Jwt\FactoryTokenProvider($a, [], [0 => '*']), $a, $this->getEnv('MERCURE_PUBLIC_URL'), ($this->privates['http_client'] ?? $this->getHttpClientService())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));

        return $this->privates['Symfony\\Component\\Mercure\\HubRegistry'] = new \Symfony\Component\Mercure\HubRegistry($b, ['default' => $b]);
    }
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('sDpvcwhmSl', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('UTbaCsAAj7', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('CDt+fM2OQv', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('gIqRf2OWY9', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.subresource_operation_factory'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kl+YFBCNPz', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.mercure.listener.response.add_link_header'] = new \ApiPlatform\Core\Mercure\EventListener\AddLinkHeaderListener(($this->privates['api_platform.metadata.resource.metadata_factory.cached'] ?? $this->getApiPlatform_Metadata_Resource_MetadataFactory_CachedService()), new \Symfony\Component\Mercure\Discovery(($this->privates['Symfony\\Component\\Mercure\\HubRegistry'] ?? $this->getHubRegistryService())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('uSbxedH3lv', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('dN06ROge2r', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(($this->privates['.service_locator.Kut4Exn'] ?? $this->get_ServiceLocator_Kut4ExnService()), new RewindableGenerator(function () {
            ...
            yield 'security.firewall.map.context.verifyCode' => ($this->privates['.security.request_matcher.sOQ0ooz'] ?? ($this->privates['.security.request_matcher.sOQ0ooz'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/verify-code-client', NULL, [0 => 'POST'])));
            yield 'security.firewall.map.context.getproduit' => ($this->privates['.security.request_matcher.Z4XdztU'] ?? ($this->privates['.security.request_matcher.Z4XdztU'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/catalogues', NULL, [0 => 'GET'])));
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'security.verifyCode._indexed_authenticators' => [

            ],
            'security.getproduit._indexed_authenticators' => [
